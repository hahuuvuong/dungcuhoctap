	...
	<div class="container">
		<div class="row">
			<div class="col col-xs-12">
				...
				<c:choose>
					<c:when test="${number_cart==1}">
						
						<h1 style="margin-top: 30px; text-align: center">Đơn Hàng</h1>
						<h2>${message}</h2>  
					</c:when>
					<c:when test="${number_cart>1}">
					<a href="history/${id}.html" class="btn btn-info"><i
						...
						<tbody>
							<c:forEach var="item" items="${listProduct}">
								<tr>
									...
									<td><a href="increase/${item.cartItemId}.html"><button
												class="btn btn-info"
							...
							<tr>
								    
								<td><a href="index.html" class="btn btn-warning"><i
