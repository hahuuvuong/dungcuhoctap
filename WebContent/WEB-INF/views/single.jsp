					...
					<div class="resp-tabs-container">
						...
						<div class="tab1">
							...
							<div class="single_page_agile_its_w3ls">
								<h6>${product.name}</h6>
								<p>Giá Bán Niêm Yết: ${product.price} vnd</p>
								<p class="w3ls_para">Giá Bán Khuyến Mãi: ${product.price - product.price*(product.discount/100)}
									vnd</p>
								<p class="w3ls_para">${product.information}</p>
							</div>
