...
<body>
	<div class="page-container">
							...
							<ul>
								<li class="dropdown profile_details_drop"><a href="#"
									...
									<ul class="dropdown-menu drp-mnu">
										...
										<li><a href="signout.html"><i class="fa fa-sign-out"></i> Logout</a>
										</li>
									</ul></li>
							</ul>
						</div>
				...
				<div class="copyrights">
					<p>
						© 2016 Shoppy. All Rights Reserved | Design by <a
							href="http://w3layouts.com/" target="_blank">Study Shoppy</a>
					</p>
				</div>
		...
		<div class="sidebar-menu">
			<div class="menu">
				<ul id="menu">
					<li id="menu-home"><a href="index.html"><i class="fa fa-home"></i><span>Home</span></a></li>

					<li id="menu-comunicacao"><a href="manageproduct.html"><i
							class="fa fa-book nav_icon"></i><span>Quản Lí Sản Phẩm</span></a>
						</li>

					<li><a href="managecart.html"><i class="fa fa-shopping-cart"></i><span>Quản Lí Giỏ Hàng</span></span></a>
						</li>
				</ul>
			</div>
		</div>
